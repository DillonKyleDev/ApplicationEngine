...
// Core log macros for message logging.
// (...) means any number of arguments and the (__VA_ARGS__) just passes those arguments
// from the base call to that function call.
